...
def particleSwarmStartCRall(transcriptionFactor1, transcriptionFactor2, progress, pieces=1):
    ...
    startParticleSwarm('CompetingRepressor', lattice, [[1,800],[1,800],[1,800],[1,800]],
...
def fn():
    prog = np.load("progressCompetingRepressor.npy")
    particleSwarmStartCRall("dot6","dot6",prog)
    particleSwarmContinueCRall("dot6","dot6",maxits=8)