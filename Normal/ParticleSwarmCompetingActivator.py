...
def particleSwarmStartCAall(transcriptionFactor1, transcriptionFactor2, progress, pieces=1):
    ...
    startParticleSwarm('CompetingActivator', lattice, [[1,800],[1,800],[1,800],[1,800]],
...
def fn():
    prog = np.load("progressCompetingActivator.npy")
    particleSwarmStartCAall("dot6","dot6",prog)
    particleSwarmContinueCAall("dot6","dot6",maxits=8)