...
def particleSwarmStartECAall(tFac1, tFac2, tFac3, progress, pieces=1):
    ...
    startParticleSwarm('ExCompetingActivatorMixed', lattice, [[1,800],[1,800],[1,800],[1,800],[1,800],[1,800]],
...
def particleSwarmContinueECAall(tFac1, tFac2, tFac3, maxits, pieces=1):
    ...
    progress = np.load("progressExCompetingActivatorMixed.npy")
    lattice = np.load("latticeExCompetingActivator.npy")
    bestPos = np.load("bestPosExCompetingActivatorMixed.npy")
    bestVals = np.load("bestValsExCompetingActivatorMixed.npy")
    swarmPos = np.load("swarmPosExCompetingActivatorMixed.npy")
    swarmVal = 1*np.load("swarmValsExCompetingActivatorMixed.npy")
    currentPos = np.load("currentPosExCompetingActivatorMixed.npy")
    currentVals = np.load("currentValsExCompetingActivatorMixed.npy")
    velocities = np.load("velocitiesExCompetingActivatorMixed.npy")
    parDict = json.load(open("parDictExCompetingActivatorMixed.json"))
    
    modelName = 'ExCompetingActivatorMixed'
...
def fn():
    prog = np.load("progressExCompetingActivatorMixed.npy")
    particleSwarmStartECAall("dot6","dot6","maf1",prog)
    particleSwarmContinueECAall("dot6","dot6","maf1",8)